...
var Code = {
	Html: {
	   portlet: `
		...
		`,
		dialog: `<div id="BND-filetree-dialog" title="Notes Downloader">
...
var Event = {
    openDownloader: function() {
        ...
        if(Data.contentArray.length === 0) {
            ...
            var contentUrl = $("#courseMenuPalette_contents>li>a:has(span[title='Content'])").attr("href");
